...
final class DateTimeHelper
{
    ...
    public function getDate($date = null, $currentFormat = null, $currentTZ = null, $expectedFormat = null, $expectedTZ = null)
    {
        ...
        return $this->getFormatted($date, $currentFormat, $currentTZ, $expectedFormat, $expectedTZ);
    }
    ...
    public function getFormatted($dateString, $currentFormat, $currentTZ, $expectedFormat, $expectedTZ)
    {
