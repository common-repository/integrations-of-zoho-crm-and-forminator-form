...
final class IpTool
{
     ...
     */
    private static function _getBrowserName($userAgent)
    {
     ...
     * @link https://stackoverflow.com/questions/18070154/get-operating-system-info
     */
    private static function _getOS($userAgent)
    {
    ...
    {
        $userDetails['ip']     = ip2long(IpTool::_checkIP());
        $userDetails['device'] = IpTool::_checkDevice();
